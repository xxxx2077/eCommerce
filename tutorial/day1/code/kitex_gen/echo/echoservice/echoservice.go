...
var EchoArgs_Req_DEFAULT *echo.Req

func (p *EchoArgs) GetReq() *echo.Req {
	if !p.IsSetReq() {
...
func (p *EchoResult) GetSuccess() *echo.Resp {
	if !p.IsSetSuccess() {
...
func (p *kClient) Echo(ctx context.Context, Req *echo.Req) (r *echo.Resp, err error) {
	var _args EchoArgs
	_args.Req = Req
